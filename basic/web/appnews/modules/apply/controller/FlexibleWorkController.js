 ...
 */
ApplyMod.controller('flexibleWorkCtr',function($scope,$http,checkModel,applyModel,Publicfactory){
    ...
    flexibleWork.beginTime = '';
    flexibleWork.endTime = '';
    flexibleWork.desc = '';
    flexibleWork.files = [];
    flexibleWork.info = {};
    flexibleWork.id = '';
    ...
    flexibleWork.submitRankInfo = function() {
        ...
        $scope.apply_param.begin_time = $scope.flexibleWork.beginTime;
        $scope.apply_param.end_time = $scope.flexibleWork.endTime;
