...
ApplymobileMod.controller('LeaveApplymobileCreateCtrl',function($scope,$http,$rootScope,Publicfactory,applyModel,$timeout,checkModel,leaveApplyModel,FileUploader,$state){
