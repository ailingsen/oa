 ...
 */
ApplymobileMod.controller('OvertimeApplymobileCreateCtrl',function($scope,$http,$state,$stateParams,applyModel,filtersModel,checkModel,Publicfactory){
    ...
    // apply_param.changetime = function(){
    //     console.log(apply_param.begin_time_str);
    // }
