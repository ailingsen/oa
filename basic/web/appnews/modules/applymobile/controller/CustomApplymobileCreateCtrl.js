 ...
 */
ApplymobileMod.controller('CustomApplymobileCreateCtrl',function($scope,$http,$location,$timeout,$rootScope,$state,$stateParams,Publicfactory,applymobileModel,applySetModel,formshowfactory){
    //局部
    ...
    if($location.path().indexOf("/customcreate") > 0){
        $timeout(function(){
        ...
        $(".formsave").click(function(){
            if(formshowfactory.formshowsave(model.formshowdata)){
                ...
                applymobileModel.createApply($scope);
            }
