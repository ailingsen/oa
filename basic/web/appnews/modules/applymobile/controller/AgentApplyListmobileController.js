 ...
 */
ApplymobileMod.controller('AgentApplyListmobileController',function($scope,$http,$state,$rootScope,$stateParams,Publicfactory,applyModel,applymobileModel,leaveApplyModel,noticeModel,permissionService){
    ...
    })($stateParams.model_id,$stateParams.apply_id,$stateParams.modeltype);
