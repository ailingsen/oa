...
}(function (angular, moment, element) {
  'use strict';
  angular.module('ui.bootstrap.datetimepicker', [])
    ...
    .directive('datetimepicker', ['$log', 'dateTimePickerConfig', function datetimepickerDirective($log, defaultConfig) {
      ...
      return {
        ...
        '   <thead>' +
        '       <tr>' +
        '           <th class="left" data-ng-click="changeView(data.currentView, data.leftDate, $event)" data-ng-show="data.leftDate.selectable"><i class="pbiconfont">&#xe60d;</i></th>' +
        '           <th class="switch" colspan="5" data-ng-show="data.previousViewDate.selectable" data-ng-click="changeView(data.previousView, data.previousViewDate, $event)">{{ data.previousViewDate.display }}</th>' +
        '           <th class="right" data-ng-click="changeView(data.currentView, data.rightDate, $event)" data-ng-show="data.rightDate.selectable"><i class="pbiconfont">&#xe60e;</i></th>' +
        '       </tr>' +
        '       <tr>' +
        ...
        '               class="day" ' +
        '               data-ng-class="{active: dateObject.active, past: dateObject.past, future: dateObject.future, disabled: !dateObject.selectable}"  data-value="{{ dateObject.display }}">{{ dateObject.display }}</td>' +
        '       </tr>' +
        '   </tbody>' +
        '</table></div>',
        scope: {
        ...
        link: function link(scope, element, attrs, ngModelController) {
          ...
          var dataFactory = {
            ...
            day: function day(unixDate) {
              ...
              //console.log(monthMoment.format('YYYY-MMM-DD'),activeDate);
          ...
          var myLeftDate = "";
          var myRightDate = "";
          var isIndexview = $(".indexTime").length;
          ...
          var getUTCTime = function getUTCTime(modelValue) {
            ...
            if( isIndexview == 1 ){
                ...
                tempDate = (modelValue ? moment(modelValue).toDate() : new Date());
            }
          ...
          scope.changeView = function changeView(viewName, dateObject, event) {
            ...
            //首页时间控件默认值
            if( isIndexview == 1 ){
                myLeftDate = moment(scope.data.leftDate.utcDateValue).format('YYYY-MM');
                myRightDate = moment(scope.data.rightDate.utcDateValue).format('YYYY-MM');
                $(".hidechangeviewLeft").html(myLeftDate);
                $(".hidechangeviewRight").html(myRightDate);
            }
