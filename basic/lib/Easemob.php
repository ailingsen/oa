...
*/
class Easemob{
	private $client_id='YXA6rLpbQJjNEeWj79VdlcJp4g';
	private $client_secret='YXA6Ww8x9VKn-YiIWHIilPnk5AraH7g';
	private $org_name='zqkt';
	private $app_name='longtuoa';
...
//------------------------------------------------------用户体系	
	...
	public function __construct($options) {
		...
		if (isset ( $this->org_name ) && isset ( $this->app_name )) {
	...
	*/
	function getToken()
	{
		...
		$url=$this->url.'token';
		//$url=$base_url.'token';
		$tokenResult = $this->postCurl($url,$body,$header=array('Content-Type: application/json','Content-Length: ' . strlen($body)));
		//return $tokenResult;
